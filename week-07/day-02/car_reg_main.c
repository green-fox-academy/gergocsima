...
int main()
{
    ...
    printf("The number of cars in the garage they older then %d are :%d\n", age, get_older_cars_than(garage, 6, age));
    printf("The number of cars with transmission in the garage: %d\n", get_transmission_count(garage, 6, CVT));
    return 0;
};
