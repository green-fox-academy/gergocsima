...
void tim2_init(){
	...
	__HAL_RCC_TIM2_CLK_ENABLE()
			;
		Tim2.Instance = TIM2;
		Tim2.Init.Period = 3333;
		Tim2.Init.Prescaler = 32400;
...
/*void TIM3_IRQHandler() {
 ...
 printf("Tim3 interrupt ignore state\n");
 interrupt_ignore = DONOTIGNORE;
 }
 if (interrupt_ignore == DONOTIGNORE && led == LEDOFF) {
 ...
 HAL_TIM_Base_Stop_IT(&Tim3);
 __HAL_TIM_SET_COUNTER(&Tim3, 0);
 printf("Tim3 interrupt on the led\n");
 HAL_TIM_Base_Start_IT(&Tim3);
 }
 if (interrupt_ignore == DONOTIGNORE && led == LEDON) {
 ...
 HAL_TIM_Base_Stop_IT(&Tim3);
 __HAL_TIM_SET_COUNTER(&Tim3, 0);
 printf("Tim3 interrupt off the led\n");
 HAL_TIM_Base_Start_IT(&Tim3);
